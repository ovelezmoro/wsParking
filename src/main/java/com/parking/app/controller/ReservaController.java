...
public class ReservaController {
    ...
    @ApiOperation(value = "updateReserva", nickname = "Actualizar Reserva", response = TReserva.class)
    @ApiResponses(value = {
        @ApiResponse(code = 200, message = "Success", response = TReserva.class),
        @ApiResponse(code = 201, message = "Created"),
        @ApiResponse(code = 400, message = "Bad Request"),
        ...
        @ApiResponse(code = 500, message = "Failure")})
    @ResponseBody
    public TReserva updateReserva(@PathVariable(name = "idreserva") Integer idreserva, @RequestBody(required = false) TReservaDTO reserva) {

        return iParkingService.updateReserva(idreserva, reserva);
