...
if len(sys.argv) == 9 :
    ...
    datos = pd.read_sql("SELECT * FROM table_2 WHERE local = " + str(local) + " and dia= "+ str(dia), conn)
    ...
    if datos.size > 0 :
        ...
        print("No se encontraron datos que correspondan a los criterios ingresados")
    
else :    
    print("Excedio la cantidad de argumentos enviados")